<?php 
    ...
    {
        header("location: signup.php?error=Username must be less than 45 characters long.");
        exit();
    }
    ...
    if (strlen($email) > 255)
    {
        header("location: signup.php?error=Email must be less than 255 characters long.");
        exit();
    }
    ...
    {
        header("location: signup.php?error=Email has wrong format.");
        exit();
    }
    ...
    {
        header("location: signup.php?error=Password doesn't meet requirements.");
        exit();
    }
    ...
    {
        header("location: signup.php?error=Confirm password is different.");
        exit();
    }
